...
export function typescript(
  ...
  return [
    ...
    {
      files: ['**/*.d.ts'],
      name: 'sncat:typescript:dts-overrides',
      rules: {
    ...
    },
    {
      ...
      name: 'sncat:typescript:tests-overrides',
      rules: {
    ...
    {
      files: ['**/*.js', '**/*.cjs'],
      name: 'sncat:typescript:javascript-overrides',
      rules: {
